...
main (int argc, char **argv)
{
	...
	if (!svc_register(transp, CALPROG, CALVERS, calprog_1, IPPROTO_UDP)) {
		fprintf (stderr, "%s", "unable to register (CALPROG, CALVERS, udp).");
		exit(1);
	}
	...
	if (!svc_register(transp, CALPROG, CALVERS, calprog_1, IPPROTO_TCP)) {
		fprintf (stderr, "%s", "unable to register (CALPROG, CALVERS, tcp).");
		exit(1);
	}
