          ...
          char *argv[])
{
  ...
  gtk_paned_add1(GTK_PANED(topVPaned), notebook);
  ...
  gtk_paned_add2(GTK_PANED(topVPaned), innerHBox);
                           
  
  gtk_container_add (GTK_CONTAINER (window), topVPaned);
